...
const delete_Category = async (req: any, res: any) => {
  try {
    const { id: Id } = req.params;
    if (!Id) return res.status(404).json({ error: "id Not Found!" });
    const id = Number(Id);
    console.log(id);
    const deleteFeatureRow = await prisma.featureRow.deleteMany({
      where: {
        id: id,
      },
    });

    res.status(200).json(deleteFeatureRow);
  } catch (error) {
    console.error(error);
    res.status(500).json({ error: "An error occurred while Delete data." });
  }
};
          ...
          create: [
            {
              ...
              Short_description:
                "Thai red curry (gaeng pet) tantalises the taste buds and provides a feast for the eyes.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Hot Pot",
                    ...
                    Short_description:
                      "Hot pot, or hotpot is one of the most popular dishes in China, especially in Sichuan Province or Chongqing.",
                    Price: 32,
                  },
                  {
                    Title: "Dumplings",
                    ...
                    Short_description:
                      "Dumplings (饺子 jiǎozi) are a traditional food type that is widely popular, especially in North China.",
                    Price: 15,
                  },
                  {
                    Title: "Fried Rice",
                    ImageURL:
                      "https://images.chinahighlights.com/allpicture/2014/09/2b424254939d4d51adda30fe_cut_750x400_39.webp",
                    Short_description:
                      "Fried rice is a dish made from fried cooked rice and other ingredients, often including eggs, vegetables, seafood, or meat.",
                    Price: 13,
                  },
                  {
                    Title: "Xiaolongbao",
                    ImageURL:
                      "https://images.chinahighlights.com/allpicture/2021/12/e0f37497683b4935b7841043_cut_750x400_39.webp",
                    Short_description:
                      "The most common xiaolongbao filling is pork. Other ingredients can include beef, crab meat, shrimp, seafood, and vegetable fillings.",
                    Price: 10,
                  },
                  {
                    Title: "Wonton Soup",
                    ImageURL:
                      "https://images.chinahighlights.com/allpicture/2017/07/241e8e1b02ef463bafa65702_cut_750x400_39.webp",
                    Short_description:
                      "Some of them look like silver ingots, making them an auspicious ‘wealth-invoking’ dish.",
                    Price: 14,
                  },
                ],
              },
            ...
            {
              Title: "Tom kha gai (coconut soup)",
              Rating: 5,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
              ...
              Short_description:
                "If you’re eating out with friends or family, tom kha gai is a great choice as part of a shared meal",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Chilli crab",
                    ImageURL:
                      "https://www.hlas.com.sg/wp-content/uploads/2020/02/20200211-Chilli-Crab.jpg",
                    Short_description:
                      "Singapore is a foodie’s paradise. While you will find restaurants from all over the world here, trying some of the island nation’s local dishes is a must.",
                    Price: 25,
                  },
                  {
                    Title: "Chicken rice",
                    ImageURL:
                      "https://www.hlas.com.sg/wp-content/uploads/2020/02/20200211-Chicken-Rice.jpg",
                    Short_description:
                      "Hainanese chicken rice is Singapore’s unofficial national dish. This deceptively simple-looking dish wows diners with the fragrance of its rice, cooked in chicken broth and coupled with perfectly poached chicken and sweet chilli sauce.",
                    Price: 20,
                  },
                  {
                    Title: "Satay",
                    ImageURL:
                      "https://www.hlas.com.sg/wp-content/uploads/2020/02/20200211-Satay.jpg",
                    Short_description:
                      "This classic Malay dish consists of skewered meats served with rice cakes and dipped in a sweet peanut sauce. Lau Pa Sat.",
                    Price: 25,
                  },
                  {
                    Title: "Laksa",
                    ImageURL:
                      "https://www.hlas.com.sg/wp-content/uploads/2020/02/20200211-Laksa.jpg",
                    Short_description:
                      "This spicy curry noodle soup is one of Singapore’s most popular Peranakan dishes, and it is easy to see why.",
                    Price: 28,
                  },
                  {
                    Title: "Bak Kut Teh",
                    ImageURL:
                      "https://www.hlas.com.sg/wp-content/uploads/2020/02/20200211-Bak-Kut-Teh.jpg",
                    Short_description:
                      "Bak Kut Teh consists of pork ribs stewed for hours in a herbal broth made of star anise, cloves, cinnamon, garlic and more.",
                    Price: 30,
                  },
                ],
              },
            ...
            },
            {
              ...
              Short_description:
                "Green curry is one of the best known Thai dishes and a firm favourite at Thai restaurants in the UK and Ireland. Although gaeng khiao wan originates from Central Thailand",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Bubur lambuk",
                    ImageURL:
                      "https://cdn.tasteatlas.com//images/dishes/fbc622d481cb461584b5a233c06a0b52.jpg?w=905&h=510",
                    Short_description:
                      "Malaysians prefer to break the fast with sweet and soft food which won't strain their stomach,",
                    Price: 20,
                  },
                  {
                    Title: "Roti canai",
                    ImageURL:
                      "https://img.theculturetrip.com/1440x/smart/wp-content/uploads/2018/08/shutterstock_259149608.jpg",
                    Short_description:
                      "This light flatbread is a staple in the street-side mamak of Malaysia. A serving of roti canai is accompanied by three dipping sauces of varying levels of spiciness.",
                    Price: 8,
                  },
                  {
                    Title: "Satay",
                    ImageURL:
                      "https://nomadparadise.com/wp-content/uploads/2020/12/malaysian-food-01-735x490.jpg.webp",
                    Short_description:
                      "Satays are similar to shish kebabs, but without the vegetables in between the meat. This dish is one of the most popular street food in Malaysia,",
                    Price: 7,
                  },
                  {
                    Title: "Bánh xèo",
                    ImageURL:
                      "https://foodandroad.com/wp-content/uploads/2021/04/banh-xeo-vietnam-comida-food-2.jpg",
                    Short_description:
            ...
            {
              Title: "Khao soi (curry noodles)",
              Rating: 4.3,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-LjgVNKQ/0/b4de9159/L/Thai_food_khao_soi-L.jpg",
              Short_description:
                "Northern Thailand’s signature dish of khao soi is a welcome inclusion in our list of favourite Thai dishes.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Kueh Teow",
                    ImageURL:
                      "https://nomadparadise.com/wp-content/uploads/2020/12/malaysian-food-08-735x490.jpg.webp",
                    Short_description:
                      "Kueh Teow is a Chinese street food specialty that has a special place in Malaysian cuisine.",
                    Price: 10,
                  },
                  {
                    Title: "Gỏi cuốn (South)",
                    ImageURL:
                      "https://res.cloudinary.com/rainforest-cruises/images/c_fill,g_auto/f_auto,q_auto/v1622728140/The-Best-Food-In-Vietnam-Rolls/The-Best-Food-In-Vietnam-Rolls.jpg",
                    Short_description:
                      "No list of food to try in Vietnam would be complete without the inclusion of nearly everyone’s favorite; fresh spring rolls.",
                    Price: 15,
                  },
                  {
                    Title: "Phở (Noodle soup)",
                    ImageURL:
                      "https://res.cloudinary.com/rainforest-cruises/images/c_fill,g_auto/f_auto,q_auto/v1622728135/The-Best-Food-In-Vietnam-Pho/The-Best-Food-In-Vietnam-Pho.jpg",
                    Short_description:
                      "OK, it’s time to get serious. One of the 2 most famous dishes to come out of Vietnam, is the mighty bowl of Phở! ",
                    Price: 13,
                  },
                  {
                    Title: "Filled Baguette",
                    ImageURL:
                      "https://res.cloudinary.com/rainforest-cruises/images/c_fill,g_auto/f_auto,q_auto/v1622728111/The-Best-Food-In-Vietnam-Banh-Mi/The-Best-Food-In-Vietnam-Banh-Mi.jpg",
                    Short_description:
                      "Now for the next of the top 2 famous Vietnamese dishes to come from Vietnam, although this time, there is little question as to the influences/origins of the dish.",
                    Price: 10,
                  },
                ],
              },
            ...
            },
            {
              ...
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-pn23MjT/0/25b78b68/XL/_Thai%20food_laab_moo_2000-XL.jpg",
              Short_description:
                "Laab is a quintessential Isaan dish. Spicy and packed with flavour, it’s a type of meat salad that is usually made with minced pork.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Bánh cuốn",
                    ImageURL:
                      "https://foodandroad.com/wp-content/uploads/2021/04/banh-cuon-vietnam-comida-food-2.jpg",
                    Short_description:
                  ...
                  },
                  {
                    ...
                    ImageURL:
                      "https://foodandroad.com/wp-content/uploads/2021/04/banh-vac-vietnam-comida-food-2.jpg",
                    Short_description:
                  ...
                  },
                  {
                    Title: "Bánh canh",
                    ImageURL:
                      "https://foodandroad.com/wp-content/uploads/2021/04/banh-canh-vietnam-comida-food-2.jpg",
                    Short_description:
                      "A noodle soup that is made from rice flour and cassava root starch. This mixture results in a thicker, rounder noodle that makes all the difference.",
                    Price: 12,
                  },
                  {
                    Title: "Bún bò Huế",
                    ImageURL:
                      "https://foodandroad.com/wp-content/uploads/2021/04/bunbo-hue-vietnam-comida-food-2.jpg",
                    Short_description:
            ...
            {
              Title: "Pad kaprao moo",
              Rating: 4.3,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-q7FQhcB/0/da497696/XL/Food_krapao_moo_khai_dao_2-XL.jpg",
              Short_description:
                "A go-to food for many Thai people, pad kaprao moo is a classic street food dish.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Shepherd's Pie",
                    ImageURL:
                      "https://www.british-study.com/en/wp-content/uploads/sites/2/2019/07/Shepherds-Pie-1.jpg",
                    Short_description:
                      "A wholesome and classic British meal, Shepherd’s Pie originated in Scotland and the North of England and is primarily made from minced lamb and potatoes.",
                    Price: 16,
                  },
                  {
                    Title: "Beef Wellington",
                    ImageURL:
                      "https://www.british-study.com/en/wp-content/uploads/sites/2/2019/07/Beef-Wellington.jpg",
                    Short_description:
                      "Beef Wellington is a fillet of steak coated in patê and then rolled in pastry. Although the dish shares its name with the famous Duke of Wellington, ",
                    Price: 10,
                  },
                  {
                    Title: "Fish and Chips ",
                    ImageURL:
                      "https://www.british-study.com/en/wp-content/uploads/sites/2/2019/07/fish-and-chips.jpg",
                    Short_description:
                      "Perhaps nothing is more synonymous with British food than fish and chips. But, unfortunately, this dish can often be a bit disappointing if you don’t get it in the right place. ",
                    Price: 13,
                  },
                ],
              },
            ...
            {
              Title: "Pad Thai (fried noodles)",
              Rating: 4.3,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-gzb8hFQ/0/17c26cf2/XL/_phat-thai-food-XL.jpg",
              Short_description:
                "One of the most popular dishes for overseas visitors, pad Thai makes for a satisfying lunch or brunch. Versions of this classic dish include chicken or pork, but it is arguably the fresh shrimp version – pad Thai kung sod – which is the best.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Eton Mess",
                    ImageURL:
                      "https://www.british-study.com/en/wp-content/uploads/sites/2/2019/07/eton-mess-1.jpg",
                    Short_description:
                  ...
                  },
                  {
                    Title: "Roast Dinner",
                    ImageURL:
                      "https://www.british-study.com/en/wp-content/uploads/sites/2/2019/07/Roast-Pork-Potatoes-Veg.jpg",
                    Short_description:
                      "The humble roast dinner began as a meal that was eaten after the Sunday church service, as the meat and vegetables could be left in the oven to cook while the family was out at worship.",
                    Price: 13,
                  },
                  {
                    Title: "Nanana San'wish",
                    ImageURL:
                      "https://restaurantclicks.com/wp-content/uploads/2022/08/Popular-British-Food.jpg",
                    Short_description: "",
                    Price: 7,
                  },
                ],
            ...
            {
              Title: "Som tam (spicy papaya salad)",
              Rating: 4.3,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-9fKmxBR/0/72a133c8/XL/som_tam_thailand-XL.jpg",
              Short_description:
                "Spicy papaya salad is a real taste of Thailand and undoubtedly one of the country’s best-loved dishes. Although som tam is associated with Isaan and North-East Thailand, it can be found in all regions of the country.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Sunday Roast",
                    ImageURL:
                      "https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/images/optimized/rev-72e5e55/images/Traditional-British-Food.jpg",
                    Short_description:
                      "A tradition if there ever was one. The Sunday roast dinner is the easiest way to forget the dread that comes with the end of the weekend.",
                    Price: 14,
                  },
                  {
                    Title: "Toad In The Hole",
                    ImageURL:
                      "https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/images/optimized/rev-72e5e55/images/British-Food-Toad-in-a-hole.jpg",
                    Short_description:
                      "If you’re wondering what ways you can include Yorkshire Pudding in more dishes, then the Toad in the Hole may be the traditional British food you’re searching for. ",
                    Price: 8,
                  },
                  {
                    Title: "Scotch Egg",
                    ImageURL:
                      "https://cdn-bmalj.nitrocdn.com/uirOOtSrYrqqUksKHkiSCjZGZlPeXsmk/assets/images/optimized/rev-72e5e55/images/British-Food-Scotch-Egg.jpg",
                    Short_description:
                      "A version of Nargisi Kofta, an Indian dish, Scotch Egg is a much-loved but odd dish that’s popular at local picnics.",
                    Price: 12,
                  },
                ],
              },
            ...
            {
              Title: "Tom yum kung (shrimp soup)",
              Rating: 4.3,
              Genre: "ThaiLand",
              Address: "Bangkok",
              ImageURL:
                "https://photos.smugmug.com/Experiences/Food-Drink/i-5wC4QF7/0/ea23d790/XL/Tom_Yum_Kung_recipe_Thaikhun_2000-XL.jpg",
              Short_description:
                "Tom yum kung doesn’t just taste good, it also does you good as well. Shrimps (kung) are an excellent source of protein and the vegetables in the soup are packed with vitamins.",
              RestaurantsDishes: {
                create: [
                  {
                    Title: "Bubur lambuk",
